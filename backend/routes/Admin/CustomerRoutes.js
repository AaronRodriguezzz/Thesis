...
router.put('/api/update_customer', verifyEmployeeToken, Customer.update_customer);
router.put('/api/disable_customer/:id', verifyEmployeeToken, Customer.disable_customer);
